...
class ktFastJet : public TObject 
{
  ...
  void DoBkgNew(Double_t Rparam=0.4,TString mAlgo="kt");
  void DoBkgStrip(Double_t Rparam=0.4,TString mAlgo="kt");
