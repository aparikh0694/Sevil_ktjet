...
ktHiForest::ktHiForest(Bool_t mQAOut,Bool_t mSC) 
{
  ...
  //DEBUG:
  //cout<<endl;
  //cout<<"Default constructor of ktHiForest ..."<<endl;
}

void ktHiForest::WriteHistograms()
{
  cout<<endl;
...
ktHiForest::~ktHiForest()
{
  ...
  //DEBUG:
  //cout<<endl;
  //cout<<"Destructor of ktHiForest ..."<<endl;
}

void ktHiForest::Clear()
{
  TriggerInfoArray->Clear("C");
}

void ktHiForest::PrintEventInfo()
{
...
void ktHiForest::PrintCuts()
{
  PrintQACuts();
}

void ktHiForest::PrintQACuts()
{
  // dummy (see TStarPico ....)
  // but implement output also khere ! (to be done)
}

void ktHiForest::WriteQAOutputFile(TString fName)
{
...
void  ktHiForest::SetTriggerInfo(TClonesArray* trinfo){

  //cout<<" ------  ktHiForest::SetTriggerInfo --------"<<endl;
...
void ktHiForest::PrintTriggerInfo()
{
  //DEBUG:
  cout<<" ------  ktHiForest::PrintTriggerInfo --------"<<endl;
  cout<<" N. of trig obj in the event = "<<TriggerInfoArray->GetEntriesFast()<<endl;
...
void ktHiForest::DoSpaceCharge(TLorentzVector *p,ktPID *pid,Float_t ZdcCoin)
{
  // DEBUG:
  /*
   if (info)
...
Bool_t ktHiForest::Fill(ktGrid *mGrid,ktFastJet *mFast,TStarJetPicoEvent *mEv,TStarJetVectorContainer<TStarJetVector>* container)
{
  //DEBUG:
  if (info)
    {
